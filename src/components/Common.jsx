...
export const SectionHeading = ({ title, subtitle }) => (
  <div className="text-center mb-16">
    <span className="text-cyan-400 text-sm font-semibold uppercase tracking-widest">— {subtitle} —</span>
    <h2 className="text-4xl font-black text-white mt-2">{title}</h2>
    <div className="w-16 h-1 bg-gradient-to-r from-cyan-500 to-violet-500 mx-auto mt-4 rounded-full"></div>
  </div>
);
